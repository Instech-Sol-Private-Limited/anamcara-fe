                    ...
                    <div className="flex justify-between items-center flex-wrap gap-4">
                        ...
                        <div className="flex items-center gap-3 sm:gap-6 min-w-0 flex-1">
                            <div className="relative flex-shrink-0">
                                <div className="w-12 h-12 sm:w-16 md:w-20 sm:h-16 md:h-20 relative">
                                    {/* Hexagonal border - keep existing clipPath styles */}
                                    <div
                                    ...
                                    />
                                    <div
                                        className="absolute inset-[2px] sm:inset-[3px] bg-[#0A0E1A] flex items-center justify-center overflow-hidden"
                                        style={{
                                            clipPath: 'polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)'
                                        }}
                                    >
                            ...
                            <div className="min-w-0 flex-1">
                                <h1 className="text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-mowaq text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 tracking-wider truncate">
                                    CATEGORY
                                </h1>
                                <div className="text-cyan-300 text-xs sm:text-sm font-mono mt-1 opacity-80 truncate">
                                    STATUS: ONLINE | COUNT: {categories.length}
                                </div>
                            </div>
                        </div>

                        {/* Add Button - Mobile: Just + icon, Desktop: Full text */}
                        <button
                            onClick={() => {
                                setIsModalVisible(true);
                                setIsEditMode(false);
                            ...
                            className="relative group px-3 py-3 sm:px-6 md:px-8 sm:py-4 font-mono font-bold tracking-wider text-black transition-all duration-300 overflow-hidden flex-shrink-0"
                            style={{
                        ...
                        >
                            <div className="flex items-center gap-2 sm:gap-3 font-mowaq">
                                <PlusOutlined style={{ fontSize: '16px' }} />
                                <span className="hidden sm:inline text-sm md:text-base">NEW.ENTITY</span>
                            </div>
                        </button>
                    </div>
                </div>
