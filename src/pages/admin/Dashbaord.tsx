            ...
            <div className="relative z-10 p-3 sm:p-4 md:p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                    ...
                    <div className="relative">
                        <div className="bg-slate-900/90 border-2 border-slate-600/50 rounded-lg backdrop-blur-lg overflow-hidden">
                            {/* Header */}
                            <div className="bg-gradient-to-r from-orange-500/10 to-red-600/10 border-b border-slate-600/50 px-3 py-2 sm:px-4 sm:py-3">
                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
                                    <div className="flex items-center gap-2 sm:gap-3">
                                        <div className="w-6 h-6 sm:w-8 sm:h-8 bg-gradient-to-br from-orange-500 to-red-600 rounded flex items-center justify-center">
                                            <FaShieldAlt className="text-white text-xs sm:text-sm" />
                                        </div>
                                        <span className="text-white font-mowaq font-bold tracking-wide text-sm sm:text-base">SECURITY_ALERTS</span>
                                        <div className="w-2 h-2 bg-red-400 rounded-full animate-pulse"></div>
                                    </div>
                                    <button
                                        onClick={() => navigate('/admin/reports')}
                                        className="text-orange-400 hover:text-white font-mowaq text-xs sm:text-sm transition-colors duration-300 border border-orange-400/30 hover:border-orange-400 px-3 py-1 rounded w-full sm:w-auto text-center"
                                    >
                                        ACCESS_ALL
                                    </button>
                                </div>
                            ...
                            <div className="p-3 sm:p-4 space-y-3">
                                {reports.slice(0, 3).map((report, index) => (
                                    <div
                                        key={index}
                                        className="bg-slate-800/50 border border-slate-600/30 rounded p-3 hover:border-orange-400/50 transition-all duration-300"
                                    >
                                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                            <div className="flex-1">
                                                <p className="text-white text-sm sm:text-base font-medium font-mowaq truncate mb-1">{report.title}</p>
                                                <p className="text-slate-400 text-xs sm:text-sm font-mowaq">
                                ...
                                {reports.length === 0 && (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-slate-500 font-mowaq text-sm sm:text-base">SYSTEM_SECURE</p>
                                    </div>
                                )}
                            </div>
                        </div>
