...
import { Home, Radio, Bell, BarChart3, Users, FileText, Settings, Gift, UserPlus, Wrench, Puzzle, GraduationCap, Shield, ChevronDown, ChevronRight, Star, Eye, MessageSquare,
...
return (
  ...
  <div className=" flex justify-center -ml-1.5 left-0 w-full -mt-10">
    <nav className="flex space-x-2 px-4 py-2 overflow-x-auto scrollbar-hide">
        ...
        return (
          <div key={item.id} className="relative">
            <button
              ...
              className={`flex items-center font-mono text-sm space-x-2 px-4 py-2 rounded-md transition-all duration-200 ${
                isActive
